...
\]
This is the vector-valued analogue of the scalar RKHS norm used for maximum mean discrepancies. The kernelized dynamic action between two probabilities is defined by
