...
\index{Benamou-Brenier}% strictindex
Assume that $\al_0^k,\al_1^k\in\Mm_+(\X)$ have the same mass $m_k$ for every $k$. For the diagonal mobility $\mathsf M_{\mathrm{diag}}$, the value of~\eqref{eq-vector-valued-bb} is
\[
...
\index{Gromov-Wasserstein!sample complexity}% strictindex
