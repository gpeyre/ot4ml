...
\index{Richardson--Romberg extrapolation}% strictindex
	...
	Combining the weak empirical expansion of~\cite{ChassagneuxSzpruchTse2022} with~\eqref{eq-higher-order-wasserstein-holder} gives, when the centered derivative kernels are uniformly bounded and with \(r_{n,p,d}\) from~\eqref{eq-holder-particle-polynomial-rate},
	\[
