...
Let \(d=\mathsf D_{\mathbb A}\) be the dynamic distance induced by the action \(\mathbb A\) in Definition~\ref{def-generalized-dynamic-action-distance}. Given \(\alpha^{(0)}\in\Pp(\RR^d)\) and \(\tau>0\), define
