...
\[
	...
	\leq 0.
\]
If \(\al_t=\sum_j w_j\de_{y_j(t)}\) carries fixed positive weights, independent of the Voronoi masses \(a_j(Y_t)\), Proposition~\ref{prop-lagrangian-flow-continuity} turns this labelled particle ODE into the weak continuity equation
\[
	\partial_t\al_t+\diverg(v_{\al_t}\al_t)=0,
	\qquad
	v_{\al_t}(y_j(t))=b_j(Y_t)-y_j(t),
\]
