...
\index{linear programming!basic feasible solution}% strictindex
...
\index{robustness!distributional}% strictindex
...
\index{robustness!Wasserstein infinity}% strictindex
