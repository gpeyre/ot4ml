...
The simplest multi-channel extension attaches several nonnegative masses to each spatial point and lets the action decide whether channels move independently or interact.
...
The continuous formulation abstracts distance matrices into metric-measure spaces, so GW compares intrinsic geometries independently of labels or ambient coordinates.
