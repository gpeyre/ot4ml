...
applied to positive matrices by spectral calculus. Equivalently, for \(M\succ0\), \(\tau_\epsilon(M) = \bigl(\sqrt{\epsilon^2 I+16M^2}-\epsilon I\bigr)(4M)^{-1}.\)
...
then $\mathcal R\nu$ is also a minimizer. If this JKO minimizer is unique, it is Gaussian.
\end{thm}
\begin{proof}
