...
\paragraph{First variations.}
The first block gives the marginal and cost derivatives.
...
\(\int\operatorname{conc}\psi\d\alpha \geq \int\operatorname{conc}\psi\d\beta \geq \int\psi\d\beta,\)
