...
\end{proof}
For a fixed jump kernel, this geometry is genuinely nonlocal and does not coincide with ordinary $\Wass_2$. Thus the continuum and graph constructions below are nonlocal analogues of Wasserstein geometry, while sharply concentrated isotropic jumps return the local theory.
