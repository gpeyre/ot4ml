...
If $d\geq2$ and $\supp(\alpha),\supp(\beta)\subset B_R$, then
\(\Wass_1(\alpha,\beta)\leq C_d R^{d/(d+1)}\SW_1(\alpha,\beta)^{1/(d+1)}\), and sharply
\(\Wass_1(\alpha,\beta)\leq c_d R^{(d-1)/d}\SW_1(\alpha,\beta)^{1/d}\).
\end{prop}
\begin{proof}
