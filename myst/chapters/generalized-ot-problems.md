...
$A_0=-I$, whose target $\beta=T_\sharp\alpha$ has a curved banana-like
geometry. Panels (b,c) plot
$t\mapsto\mathcal F_0(c_{A_t}\mid\widehat\pi_n)$ for $n=10$ and $n=200$ on
