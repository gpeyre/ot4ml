...
:::{admonition} Procedure: Cyclic Bregman projections
...
:::{admonition} Procedure: Certified entropic approximation of discrete OT
:class: ot4ml-procedure
...
The entropy correction bound then gives
...
:::{admonition} Procedure: Closed-form Gaussian Sinkhorn coupling
:class: ot4ml-procedure
...
The entropic value is then obtained by inserting the same singular values into the Gaussian Sinkhorn formula.
:::
