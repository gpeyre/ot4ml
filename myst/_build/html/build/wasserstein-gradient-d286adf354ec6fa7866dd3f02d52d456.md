...
**Conditional Wasserstein training of infinite ResNets.** Residual networks
...
limit to this depth-continuous picture.

A classical finite-depth and finite-width ResNet is a composition of residual
...
The first limit keeps the depth grid finite and sends the widths to infinity.
...
The second limit lets the depth grid become continuous. The state is now a
...
A mean-field infinite-depth and infinite-width residual network is therefore
...
More generally, let $F$ be a differentiable functional on conditional laws
...
The finite-depth and finite-width ResNet is the particle discretization of this
