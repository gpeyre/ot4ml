...
limit to this continuous-depth picture. The point of the construction is to
keep track of two independent symmetries: neurons can be relabelled inside each
...
The section follows the three limiting levels of the model. A finite ResNet is
...
step to zero turns the sequence of layer laws into a conditional measure indexed
by depth, and training becomes a Wasserstein gradient flow on this conditional
space.
