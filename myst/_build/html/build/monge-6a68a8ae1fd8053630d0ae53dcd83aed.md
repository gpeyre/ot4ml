...
diffeomorphism can compress area in one region and expand it elsewhere; the
target density is therefore not obtained by the naive composition
$\rho_\al\circ\T^{-1}$ alone. The high-density band appears exactly where the
...
diffeomorphism bends a colored square grid and compresses a narrow vertical
region. The source density is uniform, but the target density, rendered as a
blue image with contours of $\rho_\be$, becomes larger where the deformed grid
cells have smaller area. This illustrates the factor $|\det \T'(x)|^{-1}$ in the
