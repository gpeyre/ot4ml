...
Middle and right: the unregularized Fenchel--Young gap
$\mathcal L_{\mathrm{iOT}}(C(A_t);\widehat P)$ along
$A_t=-\diag(1+t,1-t)$ for $n=20$ and $n=100$. The loss vanishes at the
generating parameter $t=0$ and increases when the anisotropy departs from it.*
:::
