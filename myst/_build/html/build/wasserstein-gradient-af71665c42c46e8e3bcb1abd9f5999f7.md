...
is convex and nonincreasing on $(0,+\infty)$. Thus the corresponding internal
energy is geodesically convex in one dimension. The same $\phi$-divergence can
nevertheless fail to be geodesically convex once the reference is nonuniform.
