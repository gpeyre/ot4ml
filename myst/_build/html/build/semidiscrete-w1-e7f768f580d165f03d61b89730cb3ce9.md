...
**Quantization with non-uniform weights.** The formulation
...
$b\in\simplex_m$. Prescribing $b$, for instance $b_j=1/m$, gives an equal-weight
variant with additional structure, especially in one dimension.
