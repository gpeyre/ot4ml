...
rates. If $X_1,\ldots,X_n$ are i.i.d. samples with common law $\mu$, the associated empirical measure is
...
statement behind empirical OT plug-in estimators. It says nothing yet about
the speed, which is the topic of {ref}`sec-sample-complexity`.
...
Thus $(\Wass_p(\mu_n,\mu)^p)_n$ is uniformly integrable. Together with
almost-sure convergence to zero, this implies
...
a $\Wass_1$ form of the Berry--Esseen theorem: it controls all stable,
Lipschitz observables of the normalized sum at once.
