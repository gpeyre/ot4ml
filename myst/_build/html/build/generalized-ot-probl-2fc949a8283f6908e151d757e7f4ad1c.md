...
Under existence and uniqueness assumptions, the barycenter defines a nonlinear
flattening map

```{math}
\mathfrak A\in\mathcal P(\mathcal P(\Omega))
\longmapsto
...
When $\mathfrak A=\sum_s\lambda_s\delta_{\beta_s}$, this reduces to the
finite barycenter problem above. This map should be contrasted with the linear
