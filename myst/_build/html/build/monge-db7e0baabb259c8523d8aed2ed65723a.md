...
:::{admonition} Proposition: Bures Metric As A Lifted Second-Moment Distance
:class: important
...
Thus the Bures metric is the Wasserstein distance induced on positive
...
:::{dropdown} Proof
Fix two admissible laws $\mu,\nu$ and an arbitrary coupling $\pi$ between them,
and write
...
is positive semidefinite. For positive definite $\Sigma$ and $\Lambda$, block
positivity and the Schur complement give
...
For singular matrices, apply the same argument after adding $\eta I$ to the
two diagonal blocks of the block second-moment matrix and then let
$\eta\downarrow0$. Hence every admissible coupling has cost at least
$\Bb(\Sigma,\Lambda)^2$. Conversely, the centered Gaussian laws
