...
\inf_{\alpha_r,w_r}
\left\{
\int_0^1 \mathbb A(\alpha_r,w_r)\,\d r
:
\partial_r\alpha_r+\operatorname{div}(\alpha_r w_r)=0,
\ \alpha_{r=0}=\alpha_0,
\ \alpha_{r=1}=\alpha_1
\right\}.
```
...
\mathsf D_{\mathbb A}^2(\alpha_0,\alpha_1)
=
\inf_{\substack{\partial_t\alpha_t+\operatorname{div}(\alpha_t w_t)=0\\
\alpha_{t=0}=\alpha_0,\ \alpha_{t=1}=\alpha_1}}
\int_0^1
\left\langle Q_{\alpha_t}w_t,w_t\right\rangle_{L^2(\alpha_t)}
\d t .
```
