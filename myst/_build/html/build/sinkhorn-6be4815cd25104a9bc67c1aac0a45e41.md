...
**If** marginal residuals are below $\mathrm{tol}$, **Return**
...
**Compute** the stabilized soft transform:
...
**Compute** the stabilized reverse soft transform:
...
**If** potential changes are below $\mathrm{tol}$, **break**
