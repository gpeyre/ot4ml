...
$f(x)+g(y)=c(x,y)$. At a point where $f$ is differentiable, differentiating
this equality with respect to $x$ gives
...
squared Riemannian distance, MTW is tied to sectional curvature: negative
sectional curvature creates obstructions, while nonnegative curvature is
compatible with regularity away from cut-locus issues. Many smooth strictly
convex costs fail MTW, which is why twist is enough for existence of a map but
not for regularity.
