...
enter through the energy or through constraints. The corresponding JKO step for
a functional $F$ is
...
Multi-species Wasserstein systems and related displacement properties are
...
constrained JKO step is obtained from
{eq}`eq-multispecies-jko` by restricting the minimization to
$\mathcal C_\beta$. In the smooth-density regime, the formal constrained flow
has a common pressure $\lambda_t$:
