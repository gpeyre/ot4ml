...
positive definite in general: there are finite Euclidean point clouds for which
the Gram matrix has a negative eigenvalue. Thus no universal positive-feature
factorization of the above type should be expected. Constants in the cost, such
