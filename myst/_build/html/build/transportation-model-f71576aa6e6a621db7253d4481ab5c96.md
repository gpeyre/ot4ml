...
**Until** the training stopping criterion is met.
...
**Output:** Samples transported from the Gaussian endpoint to the data law.
...
**Compute** the mixture density $p_t$ and score $s_t=\nabla\log p_t$ in closed form.

**Set** the probability-flow velocity:
...
**End for**; **return** the final particles.
:::
...
**Sample** $z\sim\zeta$; set $x=G_{\theta_k}(z)$.
