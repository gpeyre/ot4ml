...
while preserving area. The second is a symmetric positive definite affine map,
hence the gradient of a convex quadratic potential.
...
panel applies a radius-dependent twist, which changes the parametrization of the
square grid but preserves area. The right panel then applies a symmetric
positive definite affine stretch, the gradient of a convex quadratic potential.
Faint arrows indicate the successive maps.*
:::
