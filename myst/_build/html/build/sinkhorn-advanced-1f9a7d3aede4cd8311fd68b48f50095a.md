...
{cite:p}`tameling2019empirical,hundrieser2022empirical` show that one obtains
...
assumptions on the potentials {cite:p}`delBarrioLoubes2019clt,delBarrioGonzalezSanzLoubes2022central`.
