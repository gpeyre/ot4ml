...
| $\Phi_2(\mu)$ | Raw second-moment matrix of a probability measure. | [Proposition prop-bures-second-moment-lift](monge#prop-bures-second-moment-lift) |
| $D_{\Phi_2}$ | Lifted second-moment distance, equal to the Bures metric. | [Proposition prop-bures-second-moment-lift](monge#prop-bures-second-moment-lift) |
