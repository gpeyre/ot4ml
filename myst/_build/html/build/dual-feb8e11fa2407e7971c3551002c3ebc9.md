...
slack $s(x,y)=|x-y|^2-f(x)-g(y)$, with larger slack shown in blue. The red top
strip and blue side strip show the source and target densities. The violet
curve and dots are the quantile transport contacts $(x,T(x))$, where
