...
**Free masses and prescribed weights.** The formulation
{eq}`eq-optimal-quantization-web` is the free-mass version of quantization: one
...
**Lloyd algorithm.** The computational appeal of quantization comes from
...
**Mean-field limit and ultrafast diffusion.** There is nevertheless a precise
...
<span id="alg-lloyd-quantization"></span>
...
<span id="prop-graph-w1-beckmann"></span>
