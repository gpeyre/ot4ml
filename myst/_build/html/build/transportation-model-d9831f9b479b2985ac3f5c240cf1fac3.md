...
constant, evolve particles so that their empirical law approaches $\beta$ without
...
At the density level, let $\alpha=\rho_\alpha\,\d x$ and let $v$ be a
smooth compactly supported vector field. For the perturbation
...
The right-hand side is the Stein operator applied to $v$, averaged under
$\alpha$; it remains meaningful when $\alpha$ is empirical. Restricting $v$ to
the unit ball of $\RKHS_k^d$ gives the representer formula for the steepest
descent direction,
