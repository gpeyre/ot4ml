...
the empirical law converges to $\mu$ in $\Wass_p$, almost surely and in mean.
This is the qualitative reason why empirical OT is a consistent plug-in
method; it says nothing yet about the speed, which is the topic of
...
Polish, the weak topology on probability measures admits a countable
...
$M=\int r^p\,\d\mu$. Coupling through the Dirac mass $\delta_{x_0}$ gives
...
Gaussian. Wasserstein distances make this qualitative convergence quantitative.
The next result is a $\Wass_1$ form of the Berry--Esseen theorem: it controls
all stable, Lipschitz observables of the normalized sum at once.
