...
**If** both constraint defects are below $\mathrm{tol}$, **return** $P_{k+1}$.

**End for.**

**Entropic OT specialization:**
...
**Compute** an upper bound $\widehat\Delta_k$ on the entropic dual gap.
...
**Return** the Gaussian law on $(X,Y)$ with means $(\mean_\al,\mean_\be)$, marginal covariances $(\cov_\al,\cov_\be)$, and cross-covariance $K_\epsilon$.
:::
