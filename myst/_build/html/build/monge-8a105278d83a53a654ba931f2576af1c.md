...
diffeomorphism radially compresses the middle of a colored square grid and adds
a radius-dependent twist. The source density is uniform, but the target density,
rendered as a blue image with contours of $\rho_\be$, forms an almost isotropic
central bump where the deformed grid cells have smaller area. This illustrates
the factor $|\det \T'(x)|^{-1}$ in the push-forward density formula.*
:::
