...
**Return** $(\alpha^k)_{k=0}^K$ and the interpolation $\alpha_t^\tau$.
:::
...
**Output:** Particle trajectory and empirical measures.
...
**If** a stopping criterion is met, **return** $\frac1n\sum_i\delta_{x_i^k}$.
:::
...
**If** the teacher integral is unavailable, approximate it by quadrature or a minibatch.
...
**End for**; **return** the particle trajectory.
:::
