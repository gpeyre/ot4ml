...
scales. For the self-distance $T(\hat\alpha_n,\alpha)=\Wass_p^p(\hat\alpha_n,\alpha)$, the
population value is zero and the deterministic bias
$\mathbb E\Wass_p^p(\hat\alpha_n,\alpha)$ is the leading term. In a $d$-dimensional
