...
Indeed, applying a rigid motion to one measure does not change its intrinsic
metric-measure isometry class, and {ref}`prop-gw-controlled-by-wasserstein`
then bounds GW by the ordinary Wasserstein cost after this alignment.
