...
This is the classical random-feature principle: a dense Gram matrix is replaced
by $\widetilde K=\Phi\Phi^\top$, where the number $r$ of sampled features is a
second sample size, distinct from the number of data points. At this stage no
