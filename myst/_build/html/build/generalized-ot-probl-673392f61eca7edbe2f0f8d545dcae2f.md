...
ground cost is the square of the geodesic distance {cite:p}`2015-solomon-siggraph`.(alg:gaussian-barycenter-fixed-point)=
...
fixed barycenter support.(alg:multimarginal-sinkhorn)=
...
{cite:p}`karlsson2016generalized,ma2020learning`.(alg:inverse-ot-dual-gap-learning)=
