...
| $\mathsf D_A$ | Dynamic distance induced by the homogeneous momentum action $J_A$. | [Proposition prop-homogeneous-dynamic-action-distance](dynamic-ot#prop-homogeneous-dynamic-action-distance) |
