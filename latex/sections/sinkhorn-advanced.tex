...
Sample complexity of OT and curse of dimensionality. Example of a uniform distribution on a cube. 

Aude Genevay's result on the sample complexity of Sinkhorn.
