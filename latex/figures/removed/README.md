...
`latex/figures/<figure-name>/`, and every live PDF there is referenced by the
current LaTeX source.

## Archived Figure Directories

- `barycenters-four-histograms/`
- `dual-euclidean-potential-map/`
...
- `monge-bures-spd-geodesic/`
- `monge-linearized-transport-coordinates/`
- `multimarginal-barycenter-coupling/`
- `quantum-ot-coupling-marginals/`
- `quantum-sinkhorn-scaling/`
- `sinkhorn-gaussian-regularized-geodesic/`
- `subspace-robust-wasserstein/`
- `transformer-token-measure-flow/`
- `w1-kantorovich-rubinstein-potential/`
